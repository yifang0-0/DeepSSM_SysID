...
#  not variance inference:
  nohup python main_single.py --n_epoch=750 --model='AE-RNN' --h_dim=120 --z_dim=2  --dataset='toy_lgssm_5_pre' --logdir='baseline_test_hc_relu'  --mpnt_wt=0  --do_test --do_train --train_rounds=5 &
    nohup python main_single.py --n_epoch=750 --model='AE-RNN' --h_dim=100 --z_dim=2  --dataset='toy_lgssm_5_pre' --logdir='baseline_test_hc_relu'  --mpnt_wt=0  --do_test --do_train --train_rounds=5 &
    nohup python main_single.py --n_epoch=750 --model='AE-RNN' --h_dim=80 --z_dim=2  --dataset='toy_lgssm_5_pre' --logdir='baseline_test_hc_relu'  --mpnt_wt=0  --do_test --do_train --train_rounds=5 &
    nohup python main_single.py --n_epoch=750 --model='AE-RNN' --h_dim=60 --z_dim=2  --dataset='toy_lgssm_5_pre' --logdir='baseline_test_hc_relu'  --mpnt_wt=0  --do_test --do_train --train_rounds=5 &
    nohup python main_single.py --n_epoch=750 --model='AE-RNN' --h_dim=40 --z_dim=2  --dataset='toy_lgssm_5_pre' --logdir='baseline_test_hc_relu'  --mpnt_wt=0  --do_test --do_train --train_rounds=5 &
    nohup python main_single.py --n_epoch=750 --model='AE-RNN' --h_dim=20 --z_dim=2  --dataset='toy_lgssm_5_pre' --logdir='baseline_test_hc_relu'  --mpnt_wt=0  --do_test --do_train --train_rounds=5 &
    nohup python main_single.py --n_epoch=750 --model='AE-RNN' --h_dim=10 --z_dim=2  --dataset='toy_lgssm_5_pre' --logdir='baseline_test_hc_relu'  --mpnt_wt=0  --do_test --do_train --train_rounds=5 &
